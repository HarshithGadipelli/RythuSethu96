...
const farmerSchema = new mongoose.Schema({
  ...
  soilType: {
    type: String,
    enum: ["clay", "sandy", "loamy", "silt", "peat", "chalk", "red_soil", "black_soil", "alluvial_soil", "laterite_soil", "arid_soil", "forest_soil", "saline", "other"],
    default: "loamy"
  },
  ...
  // ── Verification Photos (uploaded at registration) ──
  farmerPhoto: { type: String, default: "" },
  farmPhoto: { type: String, default: "" },
